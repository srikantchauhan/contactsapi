...
CREATE TABLE `phones` (
  ...
  CONSTRAINT `phones_ibfk_1` FOREIGN KEY (`id_contact`) REFERENCES `contacts` (`id`) ON DELETE CASCADE
...
INSERT INTO `users` VALUES (1,'srikant1','5e4716ce340cca99b92f9b2bc1c1a4a4'),(2,'srikant2','c9276cbc7c4619600c6e97b5073e55a5'),(3,'srikant3','524bc14b633b758a226452762d645965');
...
-- Dump completed on 2017-06-18 10:29:24
